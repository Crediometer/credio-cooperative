...
import { creategrouploan, createloan, createloanGroup } from "../../Redux/Loan/LaonAction";
            ...
            {memberloading ? (
                ...
                <div className="saving createloan">
                    <div className="back">
                        ...
                        <p className="title">Create Group Loan</p>
                    </div>
                                ...
                                <div className="input input-4">
                                    ...
                                    >
                                        <optgroup>
                                            ...
                                            {group?.map(((member)=>{
                                                return(
                                                    <option value={member?._id}>{member?.groupInfo?.name}</option>
                                                )       
                                            }))}
                                        </optgroup>
                                    </select>
...
const mapStateToProps = state => {
    ...
    return{
        ...
        memberloading: state?.groups?.loading,
    }
}
...
const mapDispatchToProps = dispatch => {
    return{
        createloan: (postdata, history, error) => {
            dispatch(creategrouploan(postdata, history, error));
        },
        getgroup: () => {
            dispatch(getGroup());
        },
...
export default connect(mapStateToProps, mapDispatchToProps)(GroupLoan);