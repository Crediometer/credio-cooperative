...
import { getExpences, getExpencesGroup } from "../../Redux/Expenses/ExpencesAction";
import LottieAnimation from "../../Lotties";
import preloader from "../../Assets/animations/preloader.json"
import ExpenseModalGroup from "../../components/Modal/ExpenseModalGroup";
const ExpensesGroup = ({
    getexpenses,
    loading,
    error,
    ...
    return ( 
        <div className="expenses saving">
            ...
            {show && <ExpenseModalGroup togglemodal= {handleShow} getexpenses={getexpenses}/> }
        </div>
    );
}
...
const mapDispatchToProps = dispatch => {
    return{
        getexpenses: () => dispatch(getExpencesGroup()),
    }
}

export default connect(mapStateToProps, mapDispatchToProps)(ExpensesGroup);